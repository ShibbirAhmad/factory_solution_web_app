                    ...
                    <div class="widget-content widget-content-area">
                        <form action="{{route('leaveType.update', $leave_type->id)}}" method="POST">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" name="name" value="{{$leave_type->name}}" class="form-control" placeholder="sick">
                            </div>
                            <button v-on:click="submitPayment" type="submit" class="btn btn-primary ml-3 mt-3">Update Leave Type</button>
                        </form>
